...
/**
 * 1. Почему операция tail не сводима к другим операциям
 *      Возможно, потому что надо проверить есть ли последний элемент в списке?
 * 2. Операция поиска всех узлов с заданным значением, выдающая список таких узлов, уже не нужна.
 *      Возможно, потому что мы можем ее реализовать через метод find() в методе removeAll?
 */
interface LinkedListInterface
{
    ...
    public const STATUS_RIGHT_ERROR_ONE_ITEM = 2;
    ...
    public const STATUS_REMOVE_SUCCESS = 3;
    ...
    public const STATUS_FIND_SUCCESS = 3;
